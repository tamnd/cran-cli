...
Most of these come down to network reality or how cran serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

cran rate-limits like any public site. cran already paces
...
Where a surface is gated, cran reads a cookie or token you supply
...
`cran`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what cran actually did
